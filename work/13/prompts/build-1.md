...
You are the build role of an automated software factory, working on issue 13. Your final answer is a single JSON object matching the output schema the harness was given; nothing else is the deliverable.
...
Under `work/` you may edit exactly one file: `work/13/plan.md`.
...
Creating virtual environment at: .venv
   Building textkit @ file:///home/mcnewcp/personal/my-team-fixtures/.factory/worktrees/13
      Built textkit @ file:///home/mcnewcp/personal/my-team-fixtures/.factory/worktrees/13
...
`work/13/plan.md` in this same pass: add every new path to "## Files that change" by exact
