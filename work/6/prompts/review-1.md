...
The diff under review is not reproduced here. It is the file `.factory/tmp/review-1.diff`, relative to the root of this worktree: 4521 bytes, 116 lines.

Read it completely before you judge anything: start at the beginning and keep reading with offset/limit until you have seen line 116. A single read may return only the first part of the file. Do not review from a partial read.
...
This is review round 1 of issue 6, over the commit 94452d4c2fba (0 fix round(s) so far).
